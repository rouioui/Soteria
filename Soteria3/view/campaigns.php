...
<?php include 'partials/_navbar.php' ?>
        ...
        <div class="container mt-5">
            <div class="row justify-content-center pb-3">
                <div class="col-md-7 heading-section text-center ftco-animate">
                    <span class="subheading">Best fundraisers</span>
				...
				<div class="col-md-6 col-lg-3">
					<div class="causes causes-2 ftco-animate">
						...
						<div class="text p-3" style="position:relative;">
							...
							<div class="goal mb-4">
								<p><span><?= $poste['current_amount'] ?></span> on <span><?= $poste['goal_amount'] ?></span></p>
								<div class="progress" style="height:20px">
									<div class="progress-bar bg-secondary" style="width:<?= $percentage ?>%; height:20px"><?= $percentage ?>%</div>
								</div>
							</div>
							<p><a href="campaign&campaign_id=<?= $poste['campaign_id'] ?>" class="btn btn-primary text-dark w-100">Make a donation</a></p>
						</div>
					</div>
				</div>
				<?php } ?>
	...
	<section class="ftco-section ftco-no-pb">
        <div class="container">
            <div class="row justify-content-center pb-5 mb-3">
                <div class="col-md-7 heading-section text-center ftco-animate">
                    <span class="subheading">Categories available</span>
    ...
    <section class="ftco-section ftco-no-pb">
        <div class="container">
            ...
            <p class="d-flex justify-content-center mb-5 ftco-animate"><a href="campaigns&category_id=<?= $poste['category_id'] ?>" class="btn btn-secondary">See more</a></p>
            <?php } ?>
        </div>
    </section>
	<?php }else{
				...
				<div class="col-md-6 col-lg-3">
					<div class="causes causes-2 ftco-animate">
						...
						<div class="text p-3" style="position:relative;">
							...
							<p><a href="campaign&campaign_id=<?= $poste['campaign_id'] ?>" class="btn btn-primary text-dark w-100">Make a Donations</a></p>
						</div>
					</div>
				</div>
				<?php 
